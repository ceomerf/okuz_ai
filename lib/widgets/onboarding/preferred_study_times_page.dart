...
class PreferredStudyTimesPage extends StatefulWidget {
  ...
  const PreferredStudyTimesPage({Key? key, required this.onboardingData, required this.onNext}) : super(key: key);

  @override
  State<PreferredStudyTimesPage> createState() => _PreferredStudyTimesPageState();
}

class _PreferredStudyTimesPageState extends State<PreferredStudyTimesPage> {
  final List<Map<String, dynamic>> _timeBlocks = [
    {'id': 'early_morning', 'name': 'Erken Sabah', 'time': '06:00 - 09:00', 'icon': Icons.wb_twilight},
    {'id': 'morning', 'name': 'Sabah', 'time': '09:00 - 12:00', 'icon': Icons.wb_sunny_outlined},
    {'id': 'afternoon', 'name': 'Öğlen', 'time': '12:00 - 15:00', 'icon': Icons.wb_cloudy_outlined},
    {'id': 'late_afternoon', 'name': 'İkindi', 'time': '15:00 - 18:00', 'icon': Icons.wb_shade},
    {'id': 'evening', 'name': 'Akşam', 'time': '18:00 - 21:00', 'icon': Icons.nights_stay_outlined},
    {'id': 'night', 'name': 'Gece', 'time': '21:00 - 00:00', 'icon': Icons.bedtime_outlined},
  ];
