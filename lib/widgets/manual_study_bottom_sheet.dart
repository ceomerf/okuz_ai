...
class ManualStudyBottomSheet extends ConsumerStatefulWidget {
  const ManualStudyBottomSheet({super.key});

  @override
  ConsumerState<ManualStudyBottomSheet> createState() => _ManualStudyBottomSheetState();
}

class _ManualStudyBottomSheetState extends ConsumerState<ManualStudyBottomSheet>
    with TickerProviderStateMixin {
  final _formKey = GlobalKey<FormState>();
  final StudyTrackingService _studyTrackingService = StudyTrackingService(ref.read(apiClientProvider));
  ...
  Future<void> _saveStudySession() async {
    ...
    try {
      ...
      // Immediate UI update via StudyDataNotifier
      if (mounted) {
        await ref.read(studyDataNotifierProvider.notifier).updateAfterStudySession();
      }
