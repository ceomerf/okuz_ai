...
class LegacyPaywallNotifier extends StateNotifier<PaywallState> {
  final PremiumService _premiumService;
  LegacyPaywallNotifier(this._premiumService) : super(const PaywallState());
...
final legacyPaywallNotifierProvider =
    StateNotifierProvider<LegacyPaywallNotifier, PaywallState>((ref) {
  return LegacyPaywallNotifier(ref.read(premiumServiceProvider));
});