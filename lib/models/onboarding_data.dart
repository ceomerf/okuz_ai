...
class OnboardingData {
  ...
  List<String>? workWithSchool;
  List<String>? weaknesses; // Eklendi
  bool needsSubjectSelection;
  List<int> studyDays; // Eksik alan eklendi
  String? curriculumPreference; // YKS müfredat tercihi
  List<String> studyBarriers; // Çalışma engelleri
  String? motivationType; // Motivasyon türü
  String? supportType; // Destek türü
  ...
  OnboardingData({
    ...
    this.curriculumPreference,
    this.studyBarriers = const [],
    this.motivationType,
    this.supportType,
    this.workWithSchool,
    this.weaknesses,
  ...
  factory OnboardingData.fromJson(Map<String, dynamic> json) {
    return OnboardingData(
      ...
      workWithSchool: List<String>.from(json['workWithSchool'] ?? []),
  ...
  OnboardingData copyWith({
    ...
    return OnboardingData(
      ...
      workWithSchool: workWithSchool ?? this.workWithSchool,
  ...
  List<String>? get getWorkWithSchool => workWithSchool;
  set setWorkWithSchool(List<String>? school) => workWithSchool = school;

  List<String>? get getWeaknesses => weaknesses;
  set setWeaknesses(List<String>? weaknesses) => this.weaknesses = weaknesses;
}
