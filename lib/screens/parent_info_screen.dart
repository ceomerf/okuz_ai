...
class ParentInfoScreen extends ConsumerStatefulWidget {
  const ParentInfoScreen({Key? key}) : super(key: key);

  @override
  ConsumerState<ParentInfoScreen> createState() => _ParentInfoScreenState();
}

class _ParentInfoScreenState extends ConsumerState<ParentInfoScreen> {
  ...
  Future<void> _continue() async {
    ...
    try {
      ...
      await ref.read(familyAccountNotifierProvider.notifier).updateParentInfo(
