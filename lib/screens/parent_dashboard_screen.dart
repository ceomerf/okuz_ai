...
class _ParentDashboardScreenState extends ConsumerState<ParentDashboardScreen> {
  ...
  Future<void> _loadDashboardData() async {
    ...
    try {
      final data = await ref.read(familyAccountNotifierProvider.notifier).getParentDashboardData(
  ...
  Future<void> _loadWeeklyAIReport() async {
    ...
    try {
      final result =
          await MockDatabaseService.instance.callCloudFunction('getWeeklyParentReport', {
