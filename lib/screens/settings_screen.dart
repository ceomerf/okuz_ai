                  ...
                  _buildModernSection(
                    ...
                    [
                      ...
                      Consumer(builder: (context, _, __) {
                        final familyState = ref.watch(familyAccountNotifierProvider);
                        if (familyState.isFamilyAccount) {
                            return Column(
                              children: [
                                _buildModernListTile(
                                  ...
                                  title: 'Aile Yönetimi',
                                  subtitle:
                                      '${familyState.studentProfiles.length} öğrenci profili',
                                  onTap: () =>
                          ...
                          return Column(
                            children: [
                              _buildModernListTile(
                                ...
                                subtitle:
                                    'Mevcut durum: ${subState.isPremium ? "Premium" : "Ücretsiz"}',
                                onTap: () async => ref.read(subscriptionNotifierProvider.notifier).upgradeToPremium(),
                              ),
                              _buildModernListTile(
                                icon: Icons.refresh,
                                title: 'Trial Başlat (Test)',
                                subtitle: '7 günlük trial dönemi',
                                onTap: () async => ref.read(subscriptionNotifierProvider.notifier).startUserTrial(),
                              ),
                              _buildModernListTile(
                                icon: Icons.info,
                                title: 'Subscription Durumu',
                                subtitle:
                                    'Tier: ${subState.subscriptionTier}, Trial: ${subState.isTrialActive ? "Aktif" : "Pasif"}',
                                onTap: () {},
                              ),
                              _buildModernListTile(
                                icon: Icons.star,
                                ...
                                onTap: () async => ref.read(subscriptionNotifierProvider.notifier).joinFounderMembership(),
                              ),
                            ],
                          );
                        }),
          ...
          children: [
            RadioListTile<ThemeMode>(
              ...
              onChanged: (value) {
                ...
                ref.read(appThemeNotifierProvider.notifier).setThemeMode(value!);
          ...
          children: [
            ...
            Consumer(
              builder: (context, ref, child) {
                final familyState = ref.watch(familyAccountNotifierProvider);
                final profiles = familyState.studentProfiles;
                ...
                return Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final isSelected =
                          familyState.selectedProfileId == profile.profileId;
    ...
    final result = await Navigator.of(context).push<String>(
      MaterialPageRoute(
        builder: (context) => AddStudentProfileScreen(
          onStudentAdded: (UserAccount account) async {
            await ref.read(familyAccountNotifierProvider.notifier).loadAccountData();
          },
        ),
      ),
    );
