...
class GeneratedContentScreen extends ConsumerStatefulWidget {
  final String? text;
  final String? url;
  ...
  @override
  ConsumerState<GeneratedContentScreen> createState() => _GeneratedContentScreenState();
}

class _GeneratedContentScreenState extends ConsumerState<GeneratedContentScreen>
  ...
  Future<Map<String, dynamic>?> _processContent() async {
    try {
      final result =
          await MockDatabaseService.instance.callCloudFunction('processAndStructureText', {
        'text': widget.text,
        'url': widget.url,
      });
