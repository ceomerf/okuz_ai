...
class AddStudentProfileScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AddStudentProfileScreen> createState() =>
      _AddStudentProfileScreenState();
}

class _AddStudentProfileScreenState extends ConsumerState<AddStudentProfileScreen> {
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                await MockDatabaseService.instance.addStudent(profile);
