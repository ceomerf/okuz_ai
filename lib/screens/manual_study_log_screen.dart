...
class ManualStudyLogScreen extends ConsumerStatefulWidget {
  const ManualStudyLogScreen({super.key});

  @override
  ConsumerState<ManualStudyLogScreen> createState() => _ManualStudyLogScreenState();
}

class _ManualStudyLogScreenState extends ConsumerState<ManualStudyLogScreen>
  ...
  void initState() {
    ...
    _studyTrackingService = StudyTrackingService(ref.read(apiClientProvider));
  ...
  Future<void> _saveStudyLog() async {
    ...
    try {
      ...
      // Riverpod state notifiers üzerinden güncelleme gerekiyorsa burada çağrılabilir
